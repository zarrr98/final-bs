...
const TestFile = require("../../models/file");
//const persianDate = require("persian-date");

const JWT_KEY = "dracaris";

//add test file
router.put("/addfile", upload.single("testFile"), (req, res, next) => {
  const testFile = new TestFile({
    _id: mongoose.Types.ObjectId(),
    name: req.body.name,
    testFile: req.file.path,
  });

  testFile.save()
  .then((resolve) =>
    res.status(200).json({
      message: "test file was added successfully.",
      status: 200,
      resolve,
    })
  )
